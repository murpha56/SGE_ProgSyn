...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "progsys", ("Word Stats" + "-Embed.txt"))
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Word Stats/Train.txt"
    dataset_test = "resources/progsys/Word Stats/Test.txt"
    grammar = "grammars/progsys/Word Stats.bnf"
