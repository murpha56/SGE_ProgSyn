...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "progsys", ("X-Word Lines" + "-Embed.txt"))
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/X-Word Lines/Train.txt"
    dataset_test = "resources/progsys/X-Word Lines/Test.txt"
    grammar = "grammars/progsys/X-Word Lines.bnf"
