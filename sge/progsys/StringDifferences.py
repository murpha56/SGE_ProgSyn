...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "String Differences" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/String Differences/Train.txt"
    dataset_test = "resources/progsys/String Differences/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/String Differences.bnf"
