...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Sum of Squares" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Sum of Squares/Train.txt"
    dataset_test = "resources/progsys/Sum of Squares/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Sum of Squares.bnf"
