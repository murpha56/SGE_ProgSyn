...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Vector Average" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Vector Average/Train.txt"
    dataset_test = "resources/progsys/Vector Average/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Vector Average.bnf"
