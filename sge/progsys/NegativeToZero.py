...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Negative To Zero" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Negative To Zero/Train.txt"
    dataset_test = "resources/progsys/Negative To Zero/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Negative To Zero.bnf"
