...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Double Letters" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Double Letters/Train.txt"
    dataset_test = "resources/progsys/Double Letters/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Double Letters.bnf"
