...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Smallest" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Smallest/Train.txt"
    dataset_test = "resources/progsys/Smallest/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Smallest.bnf"
