...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Syllables" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Syllables/Train.txt"
    dataset_test = "resources/progsys/Syllables/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Syllables.bnf"
