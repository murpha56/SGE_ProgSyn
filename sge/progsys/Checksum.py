...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Checksum" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Checksum/Train.txt"
    dataset_test = "resources/progsys/Checksum/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Checksum.bnf"
