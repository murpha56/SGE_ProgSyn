...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Replace Space with Newline" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Replace Space with Newline/Train.txt"
    dataset_test = "resources/progsys/Replace Space with Newline/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Replace Space with Newline.bnf"
