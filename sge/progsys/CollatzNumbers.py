...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Collatz Numbers" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Collatz Numbers/Train.txt"
    dataset_test = "resources/progsys/Collatz Numbers/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Collatz Numbers.bnf"
