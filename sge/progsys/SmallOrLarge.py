...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Small Or Large" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Small Or Large/Train.txt"
    dataset_test = "resources/progsys/Small Or Large/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Small Or Large.bnf"
