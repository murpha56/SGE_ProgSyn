...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Scrabble Score" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Scrabble Score/Train.txt"
    dataset_test = "resources/progsys/Scrabble Score/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Scrabble Score.bnf"
