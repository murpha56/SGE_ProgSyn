...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Even Squares" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Even Squares/Train.txt"
    dataset_test = "resources/progsys/Even Squares/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Even Squares.bnf"
