...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Super Anagrams" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Super Anagrams/Train.txt"
    dataset_test = "resources/progsys/Super Anagrams/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Super Anagrams.bnf"
