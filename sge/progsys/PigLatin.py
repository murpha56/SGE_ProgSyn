...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Pig Latin" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Pig Latin/Train.txt"
    dataset_test = "resources/progsys/Pig Latin/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Pig Latin.bnf"
