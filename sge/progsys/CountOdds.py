...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Count Odds" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Count Odds/Train.txt"
    dataset_test = "resources/progsys/Count Odds/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Count Odds.bnf"
