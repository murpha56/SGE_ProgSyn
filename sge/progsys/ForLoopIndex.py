...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "For Loop Index" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/For Loop Index/Train.txt"
    dataset_test = "resources/progsys/For Loop Index/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/For Loop Index.bnf"
