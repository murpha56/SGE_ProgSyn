...
class ProgSys():
    ...
    def evaluate(self, ind, dataset):
        ...
        #print(result['caseQuality'])
        #print(result["cases"])
        #ind.test_case_results = [x for x in result['caseQuality']]
        #ind.test_cases = result["cases"]

        if 'quality' not in result:
            result['quality'] = sys.maxsize
        return result['quality'], result['caseQuality'], {}
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "Last Index of Zero" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Last Index of Zero/Train.txt"
    dataset_test = "resources/progsys/Last Index of Zero/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/Last Index of Zero.bnf"
