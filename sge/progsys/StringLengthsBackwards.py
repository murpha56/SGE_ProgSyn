...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "MIT_progsys", "progsys", "String Lengths Backwards" + "-Embed.txt")
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/String Lengths Backwards/Train.txt"
    dataset_test = "resources/progsys/String Lengths Backwards/Test.txt"
    grammar = "grammars/MIT_progsys/progsys/String Lengths Backwards.bnf"
