...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "progsys", ("Wallis Pi" + "-Embed.txt"))
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Wallis Pi/Train.txt"
    dataset_test = "resources/progsys/Wallis Pi/Test.txt"
    grammar = "grammars/progsys/Wallis Pi.bnf"
